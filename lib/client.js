    ...
    if (this.autodiscover) {
        ...
        this.getHostList()
            ...
            .then(function() {
                ...
                this.connectToHosts();
                this.ring = new HashRing(Object.keys(this.connections));
            });
...
Client.prototype.disconnect = function(opts) {
    ...
    if (connections.length === Object.keys(this.connections).length) {
...
Client.prototype.ready = function() {
    var size = Object.keys(this.connections).length;
